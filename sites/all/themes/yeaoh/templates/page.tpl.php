...
<div id="page-wrapper"><div id="page">
 ...
 <div id="main-main-menu">
          ...
          global $base_url;
    	$url = 'http://'.$_SERVER ['HTTP_HOST'].$_SERVER['REQUEST_URI'] == $base_url.'index.php' ?$base_url:'http://'.$_SERVER ['HTTP_HOST'].$_SERVER['REQUEST_URI'];
...
echo'
   <div id="menus-2" > 
    ...
    <div id="for-icon">
    <a href="/user"> <i class="icon-signin icon-2x"></i></a>
    <a href="/user/register"> <i class="icon-user icon-2x"></i></a>
     </div>
   </div> '; }
